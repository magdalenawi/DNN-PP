...
def get_smiles_dicts(smilesList):
    ...
    for smiles,arrayrep in smiles_to_fingerprint_features.items():
        smiles_to_descriptors_list[smiles] = get_all_descriptors_for_smiles(smiles)
    ...
    feature_dicts = {
        ...
        'smiles_to_descriptors_list': smiles_to_descriptors_list
    }
...
def get_smiles_array(smilesList, feature_dicts):
    ...
    for smiles in smilesList:
        ...
        x_descriptors.append(feature_dicts['smiles_to_descriptors_list'][smiles])
    x_descriptors = np.asarray(x_descriptors)
    x_descriptors = np.nan_to_num(x_descriptors)
    return np.asarray(x_atom),np.asarray(x_bonds),np.asarray(x_atom_index),\
        np.asarray(x_bond_index),np.asarray(x_mask),\
        feature_dicts['smiles_to_rdkit_list'], x_descriptors
